...
RECORDS(index: number, obj?:EMT):EMT|null {
...
static createEMTCOLLECTION(builder:flatbuffers.Builder, RECORDSOffset:flatbuffers.Offset):flatbuffers.Offset {
...
unpack(): EMTCOLLECTIONT {
  return new EMTCOLLECTIONT(
    this.bb!.createObjList<EMT, EMTT>(this.RECORDS.bind(this), this.recordsLength())
  );
}


unpackTo(_o: EMTCOLLECTIONT): void {
  _o.RECORDS = this.bb!.createObjList<EMT, EMTT>(this.RECORDS.bind(this), this.recordsLength());
}
}
